	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		CursorLoader cl;
		 if (id != -1) 
		 {
			 ...
			 cl = new android.content.CursorLoader(getActivity(), contactsUri, PHONE_PROJECTION,selection, selectionArgs, sortOrder);
		 } else
		 {
			 // group cursor
			 ...
			 cl = new android.content.CursorLoader(getActivity(), contactsUri, CONTACT_PROJECTION,selection, null, sortOrder);
		 }
